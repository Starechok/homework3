...
fun main() {
    ...
    println("был(а) " + agoToText(7*DAY))
    println("был(а) " + agoToText(2*DAY + 5*HOUR))
    println("был(а) " + agoToText(1*DAY + 3*HOUR))
    println("был(а) " + agoToText(1*HOUR + 11*MIN))
    println("был(а) " + agoToText(7*HOUR + 11*MIN))
    println("был(а) " + agoToText(15*HOUR + 11*MIN))
    println("был(а) " + agoToText(17*HOUR + 11*MIN))
    println("был(а) " + agoToText(21*HOUR + 11*MIN))
    println("был(а) " + agoToText(22*HOUR + 11*MIN))
    println("был(а) " + agoToText(30*MIN))
    println("был(а) " + agoToText(27*MIN))
    println("был(а) " + agoToText(22*MIN))
    println("был(а) " + agoToText(9*MIN))
    println("был(а) " + agoToText(5*MIN))
